...
class About extends Component {
    render() {
        return (
            <div>
                <Header title="Welcome to about page" subtitle="What's your needed?" buttonText="About"
                            ...
                            <li>
                                ...
                                <div className="timeline-panel">
                                    ...
                                    <div className="timeline-body"><p className="text-muted">Lorem ipsum dolor sit amet,
                                        ...
                                        temporibus qui quibusdam, recusandae sit vero unde, sed, incidunt et ea quo
